...
export const RECOMMENDED_BLOCKLIST_URLS = [
  // HaGeZi Multi Normal (Comprehensive Ad, Tracker & Telemetry blocking)
  "https://raw.githubusercontent.com/hagezi/dns-blocklists/main/domains/normal.txt",

  // OISD Small / Domainswild (High-precision zero false-positive ad/tracker list)
  "https://small.oisd.nl/domainswild",

  // AdGuard Mobile Ads & Tracking Filter
